                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header">
                                <strong>Form Kriteria</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="../kontrol/aksi_kriteria.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Kriteria</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="nm_kriteria" placeholder="Nama Kriteria" class="form-control"></div>
                                    </div>
                                    <!-- <div class="row form-group">
