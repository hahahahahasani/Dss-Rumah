...
$query1 = mysqli_query($conn, "SELECT a.id_skala, a.value, a.keterangan, b.nm_kriteria FROM skala a, kriteria b WHERE a.id_kriteria = b.id_kriteria");
?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php while ($skala = mysqli_fetch_assoc($query1)) : ?>
                                            <tr>
                                                <td><?= $skala['id_skala'] ?></td>
                                                <td><?= $skala['nm_kriteria'] ?></td>
                                                <td><?= $skala['value'] ?></td>
